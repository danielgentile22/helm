...
precisely so this imports without onnxruntime. PASS/FAIL lines, nonzero
exit on any failure. Nothing here is device-specific, so it runs the same
on CPU as it did on CUDA.

Run: python3 voice/test_server.py
"""
import struct
import sys
