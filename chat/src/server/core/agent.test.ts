...
test("modelCatalog drops Haiku and the opaque default alias, and offers only the effort levels up to high that the SDK reports; parseModelId validates against it", async () => {
